  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-8">
      ...
      <section className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {metrics.map((metric) => (
          <article key={metric.label} className="rounded-xl border border-slate-200 bg-white p-5 shadow-civic">
      ...
      <section className="mt-6 rounded-xl border border-slate-200 bg-white p-5 shadow-civic">
